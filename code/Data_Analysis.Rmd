...
ggplot(df, aes(x = sample1 + 1)) + geom_histogram(bins = 50) +
  theme_bw(base_size = 18) + xlab("counts (sample 1)") + scale_x_log10() +
...
```
We reject $H_0$ (the difference in means is equal to 0) hence we can say that there is a difference between the two types of samples (EN and LBA) for the `r selectVar(res_splsda, comp = 1)$name[1]` bateria.
...
t.test(testEN,testLBA,paired=TRUE)
```
We reject $H_0$ (the difference in means is equal to 0) hence we can say that there is a difference between the two types of samples (EN and LBA) for the `r selectVar(res_splsda, comp = 1)$name[2]` bateria.
...
t.test(testEN,testLBA,paired=TRUE)
```
We reject $H_0$ (the difference in means is equal to 0) hence we can say that there is a difference between the two types of samples (EN and LBA) for the `r selectVar(res_splsda, comp = 1)$name[3]` bateria.
...
t.test(testEN,testLBA,paired=TRUE)
```
We reject $H_0$ (the difference in means is equal to 0) hence we can say that there is a difference between the two types of samples (EN and LBA) for the `r selectVar(res_splsda, comp = 1)$name[4]` bateria.
...
t.test(testEN,testLBA,paired=TRUE)
```
We reject $H_0$ (the difference in means is equal to 0) hence we can say that there is a difference between the two types of samples (EN and LBA) for the `r selectVar(res_splsda, comp = 1)$name[5]` bateria.
...
t.test(test0,test1)
```
We do not reject $H_0$ (the difference in means is equal to 0) hence we can say that the presence or not of these three viruses does not change the values of the `r selectVar(res_splsda, comp = 1)$name[1]` bateria.
...
t.test(test0,test1)
```
We reject $H_0$ (the difference in means is equal to 0) hence we can say that the presence or not of these three viruses changes the values of the `r selectVar(res_splsda, comp = 1)$name[2]` bateria. But the p-value is very close to 0.05...
...
t.test(test0,test1)
```
We do not reject $H_0$ (the difference in means is equal to 0) hence we can say that the presence or not of these three viruses does not change the values of the `r selectVar(res_splsda, comp = 1)$name[2]` bateria.
...
We reject $H_0$ (the difference in means is equal to 0) hence we can say that the presence or not of these three viruses changes the values of the `r selectVar(res_splsda, comp = 1)$name[2]` bateria. But the p-value is close to 0.05...
